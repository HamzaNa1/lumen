...
export const EpisodeOrderEditor = ({ itemId }: { readonly itemId: string }): React.ReactElement => {
  ...
  return (
    <div className="episode-order">
      ...
      {open ? (
        <section className="episode-order-panel" aria-label="Episode order settings">
          <div>
            <h3>Match your episode order</h3>
            <p>
              Choose the order that matches your season folders. Your files and episode numbers stay
              the same.
            </p>
          </div>
          {order.isPending ? <p role="status">Loading episode orders…</p> : null}
